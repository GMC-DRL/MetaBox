...
def get_config(args=None):
    ...
    # Training parameters
    parser.add_argument('--max_learning_step', type=int, default=3000000, help='the maximum learning step for training')
    ...
    parser.add_argument('--t_optimizer_for_cp', type=str, nargs='+', default=['DEAP_CMAES', 'Random_search'],
